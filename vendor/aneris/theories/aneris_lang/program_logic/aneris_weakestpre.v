...
Lemma aneris_wp_atomic_take_step ip E1 E2 e Φ
  ...
  TCEq (to_val e) None →
  (|={E1,E2}=>
   ∀ (extr : execution_trace aneris_lang) (atr : auxiliary_trace aneris_AS) c1,
     ...
     ∃ Q R,
       ...
       (∀ c2 δ2 ℓ oζ,
           ...
           state_interp
             ...
             (trace_extend atr () δ2) ∗
           ⌜valid_state_evolution extr atr oζ ℓ c2 δ2⌝ ∗ Q ={E2}=∗
             ⌜valid_state_evolution extr atr oζ ℓ c2 δ'⌝ ∗
             state_interp
               (trace_extend extr oζ c2)
   ...
   ∀ (extr : execution_trace aneris_lang) (atr : auxiliary_trace aneris_AS) c1,
     ...
     ∃ Q R,
       ...
       (∀ c2 δ2 ℓ oζ,
           ...
           ⌜valid_state_evolution extr atr oζ ℓ c2 δ2⌝ ∗ Q ={E2}=∗
             ⌜valid_state_evolution extr atr oζ stuttering_label c2 δ'⌝ ∗
             state_interp
               (trace_extend extr oζ c2)
