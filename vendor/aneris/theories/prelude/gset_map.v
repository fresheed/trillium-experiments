...
Section gset_flat_map.
  ...
  Proof.
    ...
    rewrite elements_disj_union //; [|by apply gset_map_disj_union].
...
Section elements.
  ...
  Proof.
    ...
    rewrite ?elements_disj_union;
      [|apply gset_map_disj_union; set_solver|set_solver].
...
Section fn_to_gmap.
  ...
  Lemma fn_to_gmap_dom (X : gset A) (f : A → B) : dom (gset A) (fn_to_gmap X f) = X.
  Proof.
  ...
  Proof.
    ...
    rewrite elements_disj_union; last first.
